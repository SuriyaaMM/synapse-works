...
def create_static_bar_plot(title,
                           y_column,
                           y_label,
                           color,
...
cpu_fig = create_static_bar_plot(title="Average CPU Time to Train (Seconds)",
                                 y_column="average_cpu_time_s",
                                 y_label="Time (s)",
                                 color=color_palette["cpu"])

cuda_fig = create_static_bar_plot(title="Average CUDA Time to Train (Seconds)",
...
accuracy_fig = create_static_bar_plot(title="Average Accuracy (%)",
