...
import { CreateModelArgs } from "../types/argTypes.js";
...
export async function createModelResolver(args: CreateModelArgs){
    ...
    setModel(new_model);
    console.log(`[synapse]: Created model: ${new_model.name} (ID: ${new_model.id})`);
    console.log(`[synapse]: Appending MODEL_CREATED Event to redis Queue`)
